...
@section('title', __('admin.faqcategories.index.title'))

@section('content_header')
    <ul class="list-inline mb-0">
        <li class="list-inline-item me-5"><strong>{{ __('admin.faqcategories.index.title') }}</strong></li>
        ...
        <tbody id="tbody">
            @forelse ($categories as $category)
                <tr>
                    ...
                    <td align="right">@include('backend.layouts.actions', ['route' => 'admin.faqcategories', 'entity' => $category])</td>
                </tr>
            @empty
